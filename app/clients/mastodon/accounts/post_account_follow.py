...
from ...models.post_account_follow_body import PostAccountFollowBody
...
def _get_kwargs(
    id: str,
    *,
    body: PostAccountFollowBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/accounts/{id}/follow".format(
            id=id,
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    r""" Follow account
     ...
     Follow the given account. Can also be used to update whether to show reblogs or enable
    notifications.
