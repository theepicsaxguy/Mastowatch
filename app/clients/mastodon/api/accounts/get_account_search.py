...
def sync_detailed(
    *,
    ...
    r""" Search for matching accounts
    ...
    Args:
        q (str): Search query for accounts.
        following (Union[Unset, bool]): Limit the search to users you are following. Defaults to
            false. Default: False.
        ...
        resolve (Union[Unset, bool]): Attempt WebFinger lookup. Defaults to false. Use this when
            `q` is an exact address. Default: False.
