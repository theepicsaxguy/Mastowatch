...
from ...models.put_push_subscription_body import PutPushSubscriptionBody
...
def sync_detailed(
    *,
    ...
    r""" Change types of notifications

     Updates the current push subscription. Only the data part can be updated. To change fundamentals, a
    new subscription must be created instead.
