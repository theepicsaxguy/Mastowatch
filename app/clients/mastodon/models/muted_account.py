...
T = TypeVar("T", bound="MutedAccount")
...
class MutedAccount:
    ...
    Attributes:
        ...
        mute_expires_at (Union[None, Unset, datetime.datetime]): When a timed mute will expire, if applicable.
    ...
    mute_expires_at: None | Unset | datetime.datetime = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        mute_expires_at: None | Unset | str
        if isinstance(self.mute_expires_at, Unset):
            mute_expires_at = UNSET
        elif isinstance(self.mute_expires_at, datetime.datetime):
            mute_expires_at = self.mute_expires_at.isoformat()
        else:
        ...
        if mute_expires_at is not UNSET:
            field_dict["mute_expires_at"] = mute_expires_at
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_mute_expires_at(data: object) -> None | Unset | datetime.datetime:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                mute_expires_at_type_0 = isoparse(data)

                return mute_expires_at_type_0
            except:  # noqa: E722
                pass
            return cast(None | Unset | datetime.datetime, data)

        mute_expires_at = _parse_mute_expires_at(d.pop("mute_expires_at", UNSET))
        ...
        muted_account.additional_properties = d
