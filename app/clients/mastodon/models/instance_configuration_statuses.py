...
T = TypeVar("T", bound="InstanceConfigurationStatuses")
...
class InstanceConfigurationStatuses:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        instance_configuration_statuses = cls(
            characters_reserved_per_url=characters_reserved_per_url,
            max_characters=max_characters,
            max_media_attachments=max_media_attachments,
        )

        instance_configuration_statuses.additional_properties = d
        return instance_configuration_statuses
