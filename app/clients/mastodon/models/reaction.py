...
class Reaction:
    ...
    count: int
    name: str
    me: None | Unset | bool = UNSET
    static_url: None | Unset | str = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_me(data: object) -> None | Unset | bool:
            if data is None:
                return data
        ...
        def _parse_static_url(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
