...
T = TypeVar("T", bound="InstanceConfigurationMediaAttachments")
...
class InstanceConfigurationMediaAttachments:
    ...
    Attributes:
        description_limit (int): The maximum size of a description, in characters.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        description_limit = d.pop("description_limit")
        ...
        instance_configuration_media_attachments = cls(
            description_limit=description_limit,
            image_matrix_limit=image_matrix_limit,
            image_size_limit=image_size_limit,
            supported_mime_types=supported_mime_types,
        ...
        instance_configuration_media_attachments.additional_properties = d
        return instance_configuration_media_attachments
