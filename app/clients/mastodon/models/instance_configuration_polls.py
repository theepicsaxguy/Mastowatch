...
T = TypeVar("T", bound="InstanceConfigurationPolls")
...
class InstanceConfigurationPolls:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        instance_configuration_polls = cls(
            max_characters_per_option=max_characters_per_option,
            max_expiration=max_expiration,
            max_options=max_options,
            min_expiration=min_expiration,
        ...
        instance_configuration_polls.additional_properties = d
        return instance_configuration_polls
