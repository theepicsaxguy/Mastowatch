...
class Filter:
    ...
    Example:
        {'id': '19972', 'title': 'Test filter', 'context': ['home'], 'expires_at': '2022-09-20T17:27:39.296Z',
            'filter_action': 'warn', 'keywords': [{'id': '1197', 'keyword': 'bad word', 'whole_word': False}], 'statuses':
