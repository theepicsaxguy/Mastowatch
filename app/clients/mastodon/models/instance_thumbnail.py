...
if TYPE_CHECKING:
    from ..models.instance_thumbnail_versions_type_0 import InstanceThumbnailVersionsType0
...
class InstanceThumbnail:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        versions: None | Unset | dict[str, Any]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_versions(data: object) -> Union["InstanceThumbnailVersionsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
