...
T = TypeVar("T", bound="V1NotificationPolicySummary")


@_attrs_define
class V1NotificationPolicySummary:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        v1_notification_policy_summary = cls(
            pending_notifications_count=pending_notifications_count,
            pending_requests_count=pending_requests_count,
        )

        v1_notification_policy_summary.additional_properties = d
        return v1_notification_policy_summary
