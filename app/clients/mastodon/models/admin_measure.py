...
class AdminMeasure:
    ...
    key: str
    total: str
    human_value: Union[None, Unset, str] = UNSET
    previous_total: Union[None, Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        human_value: Union[None, Unset, str]
        if isinstance(self.human_value, Unset):
            human_value = UNSET
        else:
            human_value = self.human_value

        previous_total: Union[None, Unset, str]
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_human_value(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
        ...
        def _parse_previous_total(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
