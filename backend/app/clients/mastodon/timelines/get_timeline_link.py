...
def sync_detailed(
    *,
    ...
    """View link timeline
     ...
     View public statuses containing a link to the specified currently-trending article. This only lists
    statuses from people who have opted in to discoverability features.
    ...
    Args:
        url_query (str): The URL of the trending article.
