...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/accounts/{id}/pin".format(
            id=id,
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    r""" Feature account on your profile

     Add the given account to the user's featured profiles. (Featured profiles are currently shown on the
    user's own public profile.)
