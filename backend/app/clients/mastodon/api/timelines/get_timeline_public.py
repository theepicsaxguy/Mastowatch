...
def sync_detailed(
    *,
    ...
    Args:
        ...
        local (Union[Unset, bool]): Show only local statuses? Defaults to false. Default: False.
        ...
        only_media (Union[Unset, bool]): Show only statuses with media attached? Defaults to
            false. Default: False.
        remote (Union[Unset, bool]): Show only remote statuses? Defaults to false. Default: False.
