...
) -> Optional[Union[Any, Error, ValidationError, list["ScheduledStatus"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ScheduledStatus.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, Error, ValidationError, list["ScheduledStatus"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, Error, ValidationError, list['ScheduledStatus']]
     """
