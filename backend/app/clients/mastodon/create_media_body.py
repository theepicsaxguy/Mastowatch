...
T = TypeVar("T", bound="CreateMediaBody")


@_attrs_define
class CreateMediaBody:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        thumbnail: Union[Unset, FileTypes] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_media_body.additional_properties = d
        return create_media_body
