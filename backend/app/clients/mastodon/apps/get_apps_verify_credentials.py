...
) -> Optional[Union[Any, Application, Error, ValidationError]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, Application, Error, ValidationError]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, Application, Error, ValidationError]
     """
