...
T = TypeVar("T", bound="CreateFilterBody")
...
class CreateFilterBody:
    ...
    Attributes:
        ...
        whole_word (Union[Unset, bool]): Should the filter consider word boundaries for this keyword? Defaults to false.
            Default: False.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_filter_body.additional_properties = d
        return create_filter_body
