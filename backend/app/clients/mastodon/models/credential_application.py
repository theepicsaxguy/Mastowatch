...
T = TypeVar("T", bound="CredentialApplication")
...
class CredentialApplication:
    ...
    Attributes:
        client_id (str): Client ID key, to be used for obtaining OAuth tokens.
        client_secret (str): Client secret key, to be used for obtaining OAuth tokens.
        client_secret_expires_at (int): When the client secret key will expire. Presently this always returns `0`
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        client_secret_expires_at = d.pop("client_secret_expires_at")
        ...
        credential_application.additional_properties = d
