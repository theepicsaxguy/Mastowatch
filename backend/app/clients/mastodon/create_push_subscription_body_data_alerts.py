...
T = TypeVar("T", bound="CreatePushSubscriptionBodyDataAlerts")


@_attrs_define
class CreatePushSubscriptionBodyDataAlerts:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_push_subscription_body_data_alerts = cls(
            mention=mention,
            status=status,
            reblog=reblog,
            follow=follow,
        ...
        create_push_subscription_body_data_alerts.additional_properties = d
        return create_push_subscription_body_data_alerts
